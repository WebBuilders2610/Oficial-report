## Solution Profile
<p align="justify">El proyecto Sistema Inteligente de Registro y Alerta Neonatal (SIRAN) surge para abordar la dificultad de detectar señales de alerta temprana en recién nacidos, un problema que a menudo se debe al agotamiento de los padres, la falta de experiencia o la ausencia de un seguimiento organizado. Estos factores pueden provocar que cambios críticos en la salud, como cuadros de deshidratación o infecciones, pasen inadvertidos y retrasen una atención médica oportuna. Por ello, el objetivo principal es facilitar la identificación de riesgos mediante una herramienta de análisis en tiempo real que sea intuitiva, cumpla con estándares médicos y garantice la total privacidad de los datos personales.</p>

<p align="justify">Como solución, se plantea una plataforma digital con una base de datos centralizada para el monitoreo de variables clave como temperatura, peso, alimentación y coloración. Este tablero inteligente no solo almacena la información, sino que genera notificaciones automáticas ante cualquier anomalía y crea reportes gráficos detallados para facilitar la labor del pediatra. La propuesta busca beneficiar tanto a centros clínicos como a padres primerizos, optimizando la toma de decisiones y estableciendo un canal de información preciso y eficiente entre el entorno familiar y el profesional de la salud.</p>
