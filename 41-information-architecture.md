...
<p><strong style="font-size:18px; color:#000000;">Heading 1 (18px, Bold, Negro)</strong></p>
<p style="font-size:18px; color:#ffffff; background:#333; padding:2px 6px; display:inline-block;">Heading 1 (18px, Normal, Blanco)</p>
<p><strong style="font-size:16px; color:#cc0000;">Heading 2 (16px, Rojo)</strong></p>
<p><strong style="font-size:16px; color:#87ceeb;">Heading 2 (16px, SkyBlue)</strong></p>
<p style="font-size:14px; color:#7cfc00;">Heading 3 (14px, LawnGreen)</p>
<p><strong style="font-size:11px; color:#cc0000;">Text (11px, Bold, Rojo)</strong></p>
<p style="font-size:9px; color:#555;">Text (9px, Blanco)</p>
